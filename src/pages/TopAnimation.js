...
const Canvas = (props) => {
    ...
    Data.reset = function () {
        ...
        Data.setConnection(connections[0]);
        this.ended = 2;
    }
    Data.step = function () {
        ...
        Data.setConnection(this.nextConnection);
    ...
    Data.setConnection = function (connection) {
    ...
    Connection.setScreen = Data.setScreen = function () {
