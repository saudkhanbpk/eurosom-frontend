...
const EnterpriseInformationManagement = () => {
...
Discover the limitless possibilities of data with our exceptional Big Data and Analytics services.  
          ...
          <div className="col-md-4 col-12">
            <img
              ...
              alt="Illustration for Big-Data-Analytics"
              className="img-fluid"
            />
          </div>
        </div>
    ...
    <div className="container-fluid">
      <div className="container">
        ...
        <h1 className="text-center text-primary fw-bold fs-1">Comprehensive Big Data and Analytics Solutions We Address</h1>
      </div>
    ...
    <div className="container position-relative">
      {cardData.map((item) => (
        <div
          key={item.id}
          className="card mb-3 border border-2 shadow-none rounded-0 p-0"
...
export default EnterpriseInformationManagement