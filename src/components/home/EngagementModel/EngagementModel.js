  ...
  return (
    <div className='container-fluid '>
      ...
      <div className="row mt-5">
        ...
        <div className="col-md-6 col-12 mt-3 mt-md-2 mt-lg-5 pt-lg-3">
          <div className='d-flex ms-md-5 gap-md-5 gap-3 align-items-center'>
            <div>
          ...
          <div className='d-flex ms-md-5 gap-md-5 gap-3 align-items-center my-lg-5 my-md-2 my-3'>
            <div>
            <img src="https://www.lucerna-tech.com/assets/media/images/icone1.svg" alt="" />
            </div>
            <div>
