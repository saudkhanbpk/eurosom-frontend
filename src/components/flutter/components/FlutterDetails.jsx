...
const FlutterDetails = () => {
  return (
    <div className="container-fluid mt-5 hero-section border rounded p-5 d-flex align-items-center">
      <div className="row w-100">
        {/* Column for the Logo and Quote Button */}
        <div className="col-12 mt-custom col-md-5 text-center mb-4 mb-md-0 d-flex flex-column align-items-center">
          <img className="image mb-4" src={FlutterLogo} alt="Flutter Logo" />
